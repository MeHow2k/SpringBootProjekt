...
public class TestGetWypozyczenia {
public static void main(String[] args) {
        ...
        try {
            ...
            for (int i=0;i<wypozyczeniaList.size(); i++)
            {
                ...
                //System.out.println(wypozyczenia.getId()+","+wypozyczenia.getFirstname()+","+wypozyczenia.getLastname()+","+wypozyczenia.getTitle()+","+wypozyczenia.getAuthor()+","+wypozyczenia.getDate()+","+wypozyczenia.getReturndate());
